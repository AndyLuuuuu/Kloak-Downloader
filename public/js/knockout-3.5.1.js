    ...
    ;(function(n) {
      ...
      a.a = (function() {
        ...
        var f = Object.prototype.hasOwnProperty,
          ...
          k = {}
        m[
          R && /Firefox\/2/i.test(R.userAgent) ? 'KeyboardEvent' : 'UIEvents'
      ...
      a.a.D('pop push reverse shift sort splice unshift'.split(' '), function(
        b
      ) {
        a.Ha.fn[b] = function() {
          var a = this.v()
                ...
                a.j.get(h, function(d) {
                  if (p === z) {
                    ...
                    f &&
                      ...
                      (q = a.i.subscribe(e, a.i.pa, f.koDescendantsComplete, f))
                    l = f
                    a.Oa(d, e)
                  }
                })
          ...
          for (q = n; l || q; )
            (n = k[l][q] - 1),
              q && n === k[l][q - 1]
                ...
                : l && n === k[l - 1][q]
                ? r.push((h[h.length] = { status: f, value: b[--l], index: l }))
                : (--q,
                  --l,
        ...
        a.a.ec = function(e, f, g, h, m, k) {
          ...
          if (r) a.a.D(f, l)
            ...
            if (!k || (t && t._countWaitingForRemove)) {
              ...
              k = a.a.Pb(E, f, { dontLimitMoves: h.dontLimitMoves, sparse: !0 })
            }
